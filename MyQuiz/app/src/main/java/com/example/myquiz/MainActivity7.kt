...
import com.example.myquiz.SportsApiService
...
class MainActivity7 : AppCompatActivity() {
    ...
    private lateinit var questions: List<SportsDataItem>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call.enqueue(object : Callback<SportsQuizResponse> {
            override fun onResponse(
                call: Call<SportsQuizResponse>,
                response: Response<SportsQuizResponse>
            ) {
                if (response.isSuccessful) {
                    ...
                    Log.e("MainActivity7", "Response not successful: ${response.code()}")
                }
            }

            override fun onFailure(call: Call<SportsQuizResponse>, t: Throwable) {
                Log.e("MainActivity7", "API call failed: ${t.message}")
            }
        })
