...
import com.example.myquiz.PoliticsApiService
import com.example.myquiz.PolQuizResponse
...
class MainActivity4 : AppCompatActivity() {
    ...
    private lateinit var questions: List<PoliticsDataItem>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val apiService = retrofit.create(PoliticsApiService::class.java)
        val call = apiService.getQuizData()

        call.enqueue(object : Callback<PolQuizResponse> {
            override fun onResponse(call: Call<PolQuizResponse>, response: Response<PolQuizResponse>) {
                if (response.isSuccessful) {
                    ...
                    Log.e("MainActivity4", "Response not successful: ${response.code()}")
                }
            }

            override fun onFailure(call: Call<PolQuizResponse>, t: Throwable) {
                Log.e("MainActivity4", "API call failed: ${t.message}")
            }
        })
